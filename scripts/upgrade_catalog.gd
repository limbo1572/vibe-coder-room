...
static func all() -> Array[Dictionary]:
	if _cache.is_empty():
		...
		# Generator tiers (Cookie Clicker–style)
		{
			"id": "tier_stackoverflow_10",
			"name": "Копіпаст з розумінням",
			"base_cost": 200.0,
			"effect_type": EffectType.GENERATOR_MULT,
			"effect_value": 2.0,
			"effect_label": "×2 Stack Overflow",
			"meme": "Тепер хоч іноді читаєш питання",
			"category": "tiers",
			"target_id": "stackoverflow",
			"unlock_at_owned": 10,
			"max_owned": 1,
		},
		{
			"id": "tier_stackoverflow_25",
			"name": "Читаю не тільки прийняту відповідь",
			"base_cost": 1600.0,
			"effect_type": EffectType.GENERATOR_MULT,
			"effect_value": 2.0,
			"effect_label": "×2 Stack Overflow",
			"meme": "Іноді навіть даунвоутнутий варіант працює краще",
			"category": "tiers",
			"target_id": "stackoverflow",
			"unlock_at_owned": 25,
			"max_owned": 1,
		},
		{
			...
			"effect_type": EffectType.GENERATOR_MULT,
			"effect_value": 2.0,
			"effect_label": "×2 ChatGPT",
			"meme": "You are a senior engineer. Не вигадуй API.",
			"category": "tiers",
			"target_id": "chatgpt",
			"unlock_at_owned": 10,
			"max_owned": 1,
		},
		{
			...
			"effect_value": 2.0,
			"effect_label": "×2 ChatGPT",
			"meme": "Менше креативу — більше комітів",
			"category": "tiers",
			"target_id": "chatgpt",
			"unlock_at_owned": 25,
			"max_owned": 1,
		...
		{
			"id": "tier_junior_10",
			"name": "Онбординг завершено",
			"base_cost": 20000.0,
			"effect_type": EffectType.GENERATOR_MULT,
			"effect_value": 2.0,
			"effect_label": "×2 джун",
			"meme": "Вже знає де кнопка Merge",
			"category": "tiers",
			"target_id": "junior",
			"unlock_at_owned": 10,
			"max_owned": 1,
		...
		{
			"id": "tier_youtube_senior_10",
			"name": "Закінчив плейлист",
			"base_cost": 120000.0,
			"effect_type": EffectType.GENERATOR_MULT,
			"effect_value": 2.0,
			"effect_label": "×2 YouTube-сіньйор",
			"meme": "12 годин туторіалів. Ну майже сіньйор.",
			"category": "tiers",
			"target_id": "youtube_senior",
			"unlock_at_owned": 10,
			"max_owned": 1,
		},
		{
			"id": "tier_youtube_senior_25",
			"name": "Сертифікат з коментарів",
			"base_cost": 1000000.0,
			"effect_type": EffectType.GENERATOR_MULT,
			"effect_value": 2.0,
			"effect_label": "×2 YouTube-сіньйор",
			"meme": "First! Also hire me",
			"category": "tiers",
			"target_id": "youtube_senior",
			"unlock_at_owned": 25,
			"max_owned": 1,
		...
		{
			"id": "tier_ai_army_10",
			"name": "Оркестратор агентів",
			"base_cost": 800000.0,
			"effect_type": EffectType.GENERATOR_MULT,
			"effect_value": 2.0,
			"effect_label": "×2 AI-армія",
			"meme": "Один агент пише, другий ревʼює, третій пушить",
			"category": "tiers",
			"target_id": "ai_army",
			"unlock_at_owned": 10,
			"max_owned": 1,
		},
		{
			...
			"effect_value": 2.0,
			"effect_label": "×2 AI-армія",
			"meme": "Вони сперечаються в PR швидше за людей",
			"category": "tiers",
			"target_id": "ai_army",
			"unlock_at_owned": 25,
			"max_owned": 1,
