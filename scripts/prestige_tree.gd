...
static func all() -> Array[Dictionary]:
	return [
		...
		},
		{
			...
			"branch": "senior",
			"cost": 5,
			"requires": ["rsi", "mech_keyboard"],
			"meme": "10x engineer energy",
			"effects": [{"type": EffectType.LOC_CLICK_MULT, "value": 2.0}],
		},
		# VIBE
		{
			"id": "autocomplete",
			...
			"effects": [{"type": EffectType.LOC_SEC_MULT, "value": 1.25}],
		},
		{
			"id": "prompt_eng",
		...
		},
		{
			...
			"branch": "vibe",
			"cost": 5,
			"requires": ["bg_agent", "generate_all"],
			"meme": "AGI написав баги швидше за тебе",
			"effects": [
				{"type": EffectType.LOC_SEC_MULT, "value": 2.0},
